 ...
 */
export const apiCache = new MemoryCache(500, 300000); // 5 min TTL
export const queryCache = new MemoryCache(1000, 600000); // 10 min TTL
export const sessionCache = new MemoryCache(5000, 1800000); // 30 min TTL
