...
export function SEO({ title = "MyMentalHealthBuddy - AI-Powered Mental Health Support", description = "Access AI-powered therapy chat, mood tracking, journaling, and mental health resources. Professional mental wellness support available 24/7 with personalized insights and crisis resources.", keywords = "mental health, AI therapy, mood tracking, journaling, crisis support, mental wellness, anxiety help, depression support, mindfulness", ogImage = "/og-image.png", ogType = "website" }) {
    useEffect(() => {
        // Update title
