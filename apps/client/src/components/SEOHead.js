...
export function SEOHead({ title, description, keywords = [], image = '/og-image.jpg', url, type = 'website', author, publishedTime, modifiedTime, }) {
    ...
    useEffect(() => {
        ...
        if (typeof window === 'undefined' || !canonicalUrl)
            return;
