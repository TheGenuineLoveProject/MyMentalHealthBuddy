...
export function DashboardPage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "fixed inset-0 w-full h-[320px] -z-10", style: { contain: 'layout strict', position: 'absolute' }, children: _jsxs(_Fragment, { children: [_jsx(AtmosphericBackground, { scene: "serenity", intensity: "moderate", showParticles: true }), _jsx(DecorativeWave, { position: "top", scene: "serenity" })] }) }), _jsxs("div", { className: "max-w-7xl mx-auto p-6 particles-bg animate-fade-in relative z-10", children: [_jsxs("div", { className: "mb-8 h-[120px] animate-slide-up overflow-hidden", style: { contain: 'layout strict' }, children: [_jsx("h1", { className: "heading-lg mb-2 text-gray-900 h-[48px] leading-tight text-shadow-soft", "data-testid": "dashboard-title", children: "Welcome to MyMentalHealthBuddy" }), _jsxs("div", { className: "flex items-center gap-2 h-[60px]", style: { contain: 'layout strict' }, children: [_jsx(Sparkles, { className: "text-yellow-500 flex-shrink-0 animate-subtle-pulse", size: 24 }), _jsx("p", { className: "text-xl text-gray-600 line-clamp-2 w-full max-w-[600px]", children: getMotivationalMessage() })] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 stats-grid", style: { contain: 'layout' }, children: stats.map((stat, index) => {
                            const Icon = stat.icon;
                            const isLoading = moodsLoading || journalsLoading || analyticsLoading;
                            return (_jsxs("div", { className: "bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500 stat-card h-[140px] card-hover-lift transition-all-smooth gpu-accelerated stagger-item", "data-testid": `stat-${stat.label.toLowerCase().replace(/\s+/g, '-')}`, style: { contain: 'layout strict', animationDelay: `${index * 100}ms` }, children: [_jsxs("div", { className: "flex items-center justify-between mb-2 h-[32px]", children: [_jsx("span", { className: "text-sm font-medium text-gray-600 truncate", children: stat.label }), _jsx("div", { className: `p-2 rounded-lg ${stat.bgColor} flex-shrink-0 hover-scale transition-transform-smooth`, children: _jsx(Icon, { className: stat.color, size: 20 }) })] }), _jsx("div", { className: "w-24 h-[48px] flex items-center justify-center", style: { contain: 'layout strict' }, children: isLoading ? (_jsx(Skeleton, { className: "h-9 w-20" })) : (_jsx("p", { className: "text-3xl font-bold text-gray-900 tabular-nums leading-none text-center w-full", "data-testid": `stat-value-${index}`, children: stat.value })) })] }, index));
