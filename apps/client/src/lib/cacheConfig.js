...
export const prefetchPriority = {
    critical: ['user', 'billing'], // Prefetch immediately
    high: ['moods', 'journal', 'content'], // Prefetch after critical
    medium: ['calendar', 'analytics', 'designs'], // Prefetch on idle
    low: ['resources', 'performance'], // Prefetch on demand
};
