...
exports.QueryBatcher = exports.QUERY_CACHE_TTL = exports.queryCache = void 0;
 ...
 * );
 */
async function cachedQuery(cacheKey, queryFn, ttl = exports.QUERY_CACHE_TTL.ACTIVITY) {
    ...
    exports.queryCache.set(cacheKey, result, ttl);
    return result;
}
/**
 ...
 * });
 */
async function paginatedQuery(options) {
 ...
 */
function logQueryMetrics(queryName, startTime, recordCount) {
 ...
 * );
 */
async function optimizedQuery(queryName, queryFn) {
