...
exports.withQueryOptimization = withQueryOptimization;
const performanceMonitor_js_1 = require("../services/performanceMonitor.js");
    ...
    async executeQuery(queryFn, options = {}) {
        ...
        try {
            ...
            if (trackPerformance) {
                ...
                performanceMonitor_js_1.performanceMonitor.addQueryMetric(queryString, duration, Array.isArray(result) ? result.length : 1);
            }
            if (useCache && cacheKey) {
...
function withQueryOptimization(queryFn, cacheKey) {
    return exports.queryOptimizer.executeQuery(queryFn, {
        useCache: !!cacheKey,
        cacheKey,
