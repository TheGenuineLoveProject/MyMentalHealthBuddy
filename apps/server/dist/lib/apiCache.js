        ...
        if (!res.locals._apiCacheApplied) {
            ...
            res.json = function (body) {
                try {
                    ...
                    const hash = crypto_1.default.createHash('sha256').update(bodyString).digest('base64');
