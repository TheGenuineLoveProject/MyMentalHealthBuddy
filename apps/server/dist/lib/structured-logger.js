...
exports.perfLogger = exports.logger = exports.PerformanceLogger = exports.StructuredLogger = exports.LogLevel = void 0;
var LogLevel;
(function (LogLevel) {
 ...
 */
exports.logger = new StructuredLogger(process.env.NODE_ENV === 'production' ? LogLevel.INFO : LogLevel.DEBUG, true, 5000);
exports.perfLogger = new PerformanceLogger(exports.logger);
