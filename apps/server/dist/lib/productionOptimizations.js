...
exports.AUTOSCALE_SERVER_CONFIG = exports.AUTOSCALE_DB_POOL_CONFIG = exports.MemoryMonitor = exports.NODE_RUNTIME_FLAGS = void 0;
exports.getNodeOptionsString = getNodeOptionsString;
exports.enableProductionOptimizations = enableProductionOptimizations;
 ...
 */
function enableProductionOptimizations() {
 ...
 */
exports.AUTOSCALE_DB_POOL_CONFIG = {
 ...
 */
exports.AUTOSCALE_SERVER_CONFIG = {
 ...
 */
function createHealthCheck(checks = {}) {
    return async () => {
        const results = {};
        // Database check
        if (checks.database) {
