...
exports.QuotaExceededError = exports.TimeoutError = exports.APIKeyError = exports.RateLimitError = exports.OpenAIError = void 0;
...
class APIKeyError extends OpenAIError {
...
async function generateChatResponse(userMessage, chatHistory = [], retryCount = 0) {
    const messages = [
...
async function* streamChatResponse(userMessage, chatHistory = []) {
    const messages = [
        { role: "system", content: MENTAL_HEALTH_SYSTEM_PROMPT },
        ...chatHistory,
        { role: "user", content: userMessage }
