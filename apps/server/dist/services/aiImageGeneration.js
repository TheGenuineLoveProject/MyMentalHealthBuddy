...
exports.PROMPT_TEMPLATES = exports.aiImageService = exports.AIImageGenerationService = void 0;
...
class AIImageGenerationService {
    ...
    async generateImage(request) {
        ...
        try {
            ...
            const imageBuffer = node_buffer_1.Buffer.from(base64, 'base64');
    ...
    createMediaAssetRecord(result, request) {
        const filename = `ai-generated-${Date.now()}-${crypto_1.default.randomBytes(4).toString('hex')}.png`;
...
exports.aiImageService = new AIImageGenerationService();
/**
