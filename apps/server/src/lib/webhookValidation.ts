 ...
 */
export function validateStripeWebhook(stripe: Stripe) {
...
export function ensureWebhookIdempotency(req: Request, res: Response, next: NextFunction) {
 ...
 */
export function validateWebhookEventType(allowedTypes: string[]) {
  return (req: Request, res: Response, next: NextFunction) => {
    const event = req.body;
