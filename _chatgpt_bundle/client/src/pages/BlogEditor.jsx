    ...
    return (
      <div className="min-h-screen bg-[var(--glp-paper)]">
        ...
        <div className="max-w-3xl mx-auto px-4 py-20 text-center">
          ...
          <Link href="/login">
            <button className="mt-6 px-6 py-3 rounded-xl bg-[var(--glp-sage-deep)] text-white text-sm font-medium hover:bg-[#8FBF9F] transition-colors" data-testid="button-login">
              Sign In
            </button>
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[var(--glp-paper)]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <Link href="/blog">
            <button className="flex items-center gap-2 text-sm text-[var(--glp-sage-deep)] hover:text-[#8FBF9F] transition-colors" data-testid="button-back">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={createMutation.isPending || !title.trim() || !content.trim()}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--glp-sage-deep)] text-white text-sm font-medium hover:bg-[#8FBF9F] transition-colors disabled:opacity-50"
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="card-glass p-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl border border-[rgba(var(--glp-sage-deep-rgb), 0.25)] bg-white/70 text-sm focus:outline-none focus:ring-2 focus:ring-[#8FBF9F]/50"
            ...
            <div className="card-glass p-6">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2 rounded-xl border border-[rgba(var(--glp-sage-deep-rgb), 0.25)] bg-white/70 text-sm focus:outline-none focus:ring-2 focus:ring-[#8FBF9F]/50 resize-none"
