  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        {/* HERO */}
        <section className="relative overflow-hidden rounded-3xl border border-[rgba(var(--glp-sage-rgb), 0.22)] bg-[rgba(250,249,247,0.55)] p-8 shadow-sm backdrop-blur">
          {/* glow orbs */}
          ...
          <div className="relative">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                style={{ background: "linear-gradient(90deg, var(--glp-sage-deep) 0%, #8FBF9F 55%, var(--glp-gold) 100%)" }}
              >
                Start Your Journey →
              </a>
              <a
