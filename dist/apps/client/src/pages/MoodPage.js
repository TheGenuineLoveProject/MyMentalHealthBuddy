...
export function MoodPage() {
    ...
    return (_jsxs("div", { className: "max-w-4xl mx-auto p-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h1", { className: "text-3xl font-bold", children: "Mood Tracker" }), moods.length > 0 && (_jsxs("div", { className: "flex gap-2", children: [_jsxs("button", { onClick: () => handleExport("csv"), className: "px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center gap-2", "data-testid": "button-export-csv", children: [_jsx(Download, { size: 16 }), "Export CSV"] }), _jsxs("button", { onClick: () => handleExport("json"), className: "px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2", "data-testid": "button-export-json", children: [_jsx(Download, { size: 16 }), "Export JSON"] })] }))] }), _jsxs("div", { className: "bg-white rounded-lg shadow p-6 mb-6", children: [_jsx("h2", { className: "text-xl font-semibold mb-4", children: "How are you feeling?" }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium mb-2", children: "Mood" }), _jsx("div", { className: "grid grid-cols-4 gap-2", children: MOODS.map((m) => (_jsx("button", { type: "button", onClick: () => setMood(m), className: `px-4 py-2 rounded-lg border ${mood === m
