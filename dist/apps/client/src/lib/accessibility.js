 ...
 */
export function getNavLinkAria(isActive, label) {
    return {
        'aria-label': label,
 ...
 */
export function getButtonAria(label, isDisabled = false, isPressed) {
    return {
        'aria-label': label,
 ...
 */
export function getModalAria(titleId, descriptionId) {
    return {
        role: 'dialog',
        'aria-modal': true,
 ...
 */
export function getInputAria(label, isInvalid = false, isRequired = false, errorId) {
    return {
        'aria-label': label,
 ...
 */
export function getDisclosureAria(isExpanded, controlsId, label) {
    return {
 ...
 */
export function getTabAria(isSelected, controlsId, label) {
    return {
        role: 'tab',
 ...
 */
export function getMenuAria(isOpen, label) {
    return {
        'aria-haspopup': 'menu',
