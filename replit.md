...
**Landing Page Architecture** (CanvaLanding.jsx): The landing page uses an NLP-informed emotional journey structure with 9 sections: Hero → Stats → About → Philosophy → Features → Steps → Testimonials → FAQ → Final CTA. The "Philosophy" section (`id="philosophy"`) introduces 4 pillars (Attunement Over Advice, Your Mind Is Unique, Unconditional Presence, Growth Without Pressure) with a manifesto quote in a consciousness-expanding visual container. All copy is crafted with NLP positioning (embedded presuppositions, autonomy-preserving language, emotional attunement).
...
- **Brand Color Palette ("Empathic Intelligence")**: Living Sage #4abf90, Mystic Teal #163d3d, Moonlit Pearl #faf8f4, Teal Ink #1c2b2b, Luminous Amber #d4a840, Deep Amber #bf9632, Heart Rose #e0a09c. Section dividers use a gold-sage gradient line between all major landing page sections.
