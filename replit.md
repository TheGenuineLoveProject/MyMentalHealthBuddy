...
- **3-Level Reading Mode System**: Beginner/Standard/Deep reading level toggle with URL query (?level=beginner|standard|deep), localStorage persistence, route-specific defaults, and variant resolution for hero/sections/cards. Inclusive language guidelines: person-first, non-stigmatizing, no moralizing terms.
