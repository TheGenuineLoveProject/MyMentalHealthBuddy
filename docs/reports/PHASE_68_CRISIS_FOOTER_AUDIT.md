# Phase 68 — Sensitive Route Crisis Footer Audit

## Purpose
Verify sensitive public wellness pages are documented for crisis-footer review before any route consolidation.

## Required crisis literals
- 988
- 741741
- 911
- /crisis
...
## Production crisis page verification
      #root:not(:empty) ~ .crisis-fallback { display: none; }
      .crisis-fallback {
      .crisis-fallback h1 { font-size: 1.25rem; margin: 0 0 .5rem; }
      .crisis-fallback ul { padding-left: 1.25rem; margin: .75rem 0; }
      .crisis-fallback li { margin: .35rem 0; }
      .crisis-fallback a { color: #1d6f4a; text-decoration: underline; }
      .crisis-fallback p.note { font-size: .9rem; color: #4a5a53; margin-top: 1rem; }
    <noscript>
      <style>.crisis-fallback { display: block !important; }</style>
    </noscript>
    <aside class="crisis-fallback" role="complementary" aria-label="Crisis resources">
        <li><strong>Call or text <a href="tel:988">988</a></strong> — Suicide &amp; Crisis Lifeline (US, 24/7)</li>
        <li><strong>Text HOME to <a href="sms:741741&amp;body=HOME">741741</a></strong> — Crisis Text Line (US, 24/7)</li>
        <li><strong>Dial <a href="tel:911">911</a></strong> — for an immediate emergency in the US</li>

## Sensitive route candidates found
...
## Phase decision
Documentation only. No source route edits. No merges. No deletions.

## Next safe action
Per-page verification before any sensitive topic page consolidation.
