...
if (!offline.includes("prevents an old cached page from loading outdated app files")) failures.push("OFFLINE_STALE_CACHE_EXPLANATION_MISSING");
if (!offline.includes("988")) failures.push("OFFLINE_SAFETY_988_COPY_MISSING");
if (main.includes("controllerchange") && main.includes("window.location.reload")) failures.push("MAIN_CONTROLLERCHANGE_FORCE_RELOAD_PRESENT");
