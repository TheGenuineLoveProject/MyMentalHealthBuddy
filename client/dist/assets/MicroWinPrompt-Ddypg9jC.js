import{a as b}from"./rolldown-runtime-DVDPw_7t.js";import{a as v}from"./vendor-forms-Cg1Ymwf3.js";import{r as x,s as y}from"./vendor-router-B33XX3iJ.js";import{i as k}from"./vendor-motion-B-mBy_jn.js";import{Bn as E,X as F,a as _,n as j}from"./vendor-lucide-CyMIVN6-.js";import{r as S}from"./nlpMiContent-CDh_lY9W.js";var o=b(v(),1),t=k(),p="mmhb:microwin_shown",L=45e3,N="mmhb_token",T=2200;function A(n){if(typeof window>"u")return null;try{return window.sessionStorage.getItem(n)}catch{return null}}function C(n,s){if(!(typeof window>"u"))try{window.sessionStorage.setItem(n,s)}catch{}}function B(){if(typeof window>"u")return!1;try{return!!window.localStorage.getItem(N)}catch{return!1}}function D(){const[n,s]=(0,o.useState)(!1),[c,u]=(0,o.useState)(!1),w=(0,o.useMemo)(()=>S(),[]),[m]=y(),l=(0,o.useRef)(null),a=(0,o.useRef)(null),d=()=>{c||(u(!0),a.current=window.setTimeout(()=>s(!1),T))};(0,o.useEffect)(()=>()=>{a.current&&window.clearTimeout(a.current)},[]),(0,o.useEffect)(()=>{if(!n)return;const i=window.setTimeout(()=>{try{l.current?.focus()}catch{}},50);return()=>window.clearTimeout(i)},[n]),(0,o.useEffect)(()=>{if(typeof window>"u"||A(p)==="true")return;let i=null;const e=()=>{i&&window.clearTimeout(i),i=window.setTimeout(()=>{s(!0),C(p,"true")},L)};e();const r={passive:!0};return window.addEventListener("click",e,r),window.addEventListener("scroll",e,r),window.addEventListener("keydown",e,r),window.addEventListener("touchstart",e,r),()=>{i&&window.clearTimeout(i),window.removeEventListener("click",e,r),window.removeEventListener("scroll",e,r),window.removeEventListener("keydown",e,r),window.removeEventListener("touchstart",e,r)}},[]),(0,o.useEffect)(()=>{if(!n)return;const i=e=>{e.key==="Escape"&&d()};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[n]);const f=m==="/crisis"||m.startsWith("/crisis/");if(!n||f)return null;const h=B()?"/chat":"/login";return(0,t.jsxs)("div",{className:"mwp-shell",role:"dialog","aria-modal":"false","aria-label":"A gentle moment of calm","data-testid":"prompt-micro-win",children:[(0,t.jsxs)("div",{className:"mwp-card",children:[(0,t.jsx)("button",{type:"button",ref:l,onClick:d,className:"mwp-close","aria-label":"Dismiss this gentle prompt","data-testid":"button-micro-win-dismiss",children:(0,t.jsx)(j,{className:"w-4 h-4","aria-hidden":"true"})}),c?(0,t.jsx)("p",{className:"mwp-msg mwp-msg--resistance",role:"status","aria-live":"polite","data-testid":"text-micro-win-resistance",children:w}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("p",{className:"mwp-msg",children:"You don't have to figure everything out right now. Would you like a moment of calm?"}),(0,t.jsx)("div",{className:"mwp-options",children:[{label:"Take one calm breath",href:"/tools/breathing",Icon:_,accent:"#74C0FC"},{label:"Name how you feel",href:"/checkin",Icon:E,accent:"#FFB88C"},{label:"Meet your companion",href:h,Icon:F,accent:"#C8B6FF"}].map(({label:i,href:e,Icon:r,accent:g})=>(0,t.jsxs)(x,{href:e,className:"mwp-opt","data-testid":`link-micro-win-${e.replace(/\//g,"-").slice(1)||"home"}`,onClick:()=>s(!1),style:{"--mwp-accent":g},children:[(0,t.jsx)("span",{className:"mwp-opt__icon","aria-hidden":"true",children:(0,t.jsx)(r,{className:"w-4 h-4"})}),(0,t.jsx)("span",{children:i})]},e))})]})]}),(0,t.jsx)("style",{children:`
        .mwp-shell {
          position: fixed;
          left: 50%;
