import{a as m}from"./rolldown-runtime-DVDPw_7t.js";import{a as c}from"./vendor-forms-Cg1Ymwf3.js";import{i as v}from"./vendor-motion-B-mBy_jn.js";var y=m(c(),1),i=v(),w=y.forwardRef(({checked:r=!1,onCheckedChange:e,disabled:t=!1,className:o="",id:n,name:l,"data-testid":s,"aria-label":u,"aria-labelledby":b,...d},f)=>{const g=a=>{a.preventDefault(),a.stopPropagation(),!t&&e&&e(!r)},p=a=>{t||(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),e?.(!r))};return(0,i.jsx)("button",{type:"button",role:"switch","aria-checked":r,"aria-label":u,"aria-labelledby":b,disabled:t,ref:f,id:n,name:l,"data-testid":s,"data-state":r?"checked":"unchecked",onClick:g,onKeyDown:p,className:`
        ...
        `.trim().replace(/\s+/g," "),...d,children:(0,i.jsx)("span",{"aria-hidden":"true",className:`
          ...
          `.trim().replace(/\s+/g," ")})})});w.displayName="Switch";export{w as t};
