...
export default function CanvaLanding() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#F6F1E8] via-[#F8F8F4] to-[#7BA483]/15 text-[#163A36]">
      <section className="mx-auto max-w-7xl px-6 py-20">
        <p className="text-sm font-bold uppercase tracking-[0.25em] text-[#163A36]">
        ...
        <p className="mt-6 max-w-3xl text-xl leading-8 text-[#2A3F3D]">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link to="/7-day-reset" className="rounded-full bg-[#163A36] px-6 py-4 font-bold text-white">
            Start the 7-Day Reset
          </Link>
          <Link to="/pricing" className="rounded-full border border-[#163A36]/20 bg-white/70 px-6 py-4 font-bold">
            View Pricing
          </Link>
          <Link to="/tools" className="rounded-full border border-[#163A36]/20 bg-white/70 px-6 py-4 font-bold">
            Explore Tools
          </Link>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <article key={title} className="rounded-3xl border border-[#163A36]/10 bg-white/70 p-6 shadow-xl shadow-[#163A36]/5">
              <h2 className="text-xl font-extrabold">{title}</h2>
              <p className="mt-3 leading-7 text-[#2A3F3D]">{body}</p>
            </article>
          ))}
        </div>

        <section className="mt-10 rounded-3xl border border-[#163A36]/10 bg-white/75 p-8 shadow-xl shadow-[#163A36]/5">
