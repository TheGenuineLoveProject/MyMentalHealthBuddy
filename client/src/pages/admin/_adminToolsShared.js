...
// Verbatim relocation: TOOL_ADMIN_LINKS, TOOL_SEVERITY, AI_REMEDIATION,
// getRemediation, toolCategories, CRITICAL_CHECKS.
// toolCategories + CRITICAL_CHECKS included (beyond user's 4-item list)
// because AIRepairCenter references them; no other resolution preserves
// the 'exact props' contract.

import { MessageSquare, Headphones, Heart, BookOpen, Sun, Moon, Leaf, Eye, FileQuestion, Gauge, Lightbulb, Landmark, GraduationCap, Brain, Sparkles, Mountain, Compass, Trophy, Layers, Puzzle, Milestone, HeartHandshake, Flame, Target, Flower2, TreePine, Feather, CircleDot, Shield, Gem, Award, Zap, TrendingUp, Star, Rocket, Orbit, Footprints, Workflow, Globe, Network, Users, FileText, Palette, Mail, Share2, Megaphone, PenTool, Search, Rss, UserCheck, LayoutDashboard, Inbox, Wand2, ShieldCheck, ClipboardList, CreditCard, BarChart3, Activity, PackageCheck, HardDrive, Terminal, DollarSign, Webhook, Contact, Key, Handshake, LogIn, UserCog, Upload, ListOrdered, Radio, Fingerprint, FolderKanban } from 'lucide-react';

export const TOOL_ADMIN_LINKS = {
...
export function getRemediation(label, ms) {
