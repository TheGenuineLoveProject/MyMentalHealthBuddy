  ...
  sections: [
    {
      ...
      cta: { label: 'Take a Calm Breath', href: '/tools/breathing' },
    },
    {
      icon: 'Heart',
      ...
      cta: { label: 'Talk With Lumi', href: '/chat' },
    },
    {
      icon: 'Sparkles',
      ...
      cta: { label: 'Explore Gentle Tools', href: '/tools' },
    },
    {
      icon: 'Shield',
      ...
      avatar: '/brand/v17/avatar-heart.png',
      avatarWebp: '/brand/v17/avatar-heart.webp',
      cta: { label: 'Crisis Support', href: '/crisis' },
    },
  ],
};
