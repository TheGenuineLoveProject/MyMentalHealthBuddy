...
export default function RelatedNextSteps({ steps, title = "Related Next Steps" }) {
  if (!steps || steps.length === 0) return (
    <div className="min-h-screen safe-padding hero-gradient">
      <SEO title="Related Next Steps — The Genuine Love Project" description="Explore related next steps tools for your wellness journey." />
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-4">Related Next Steps</h1>
