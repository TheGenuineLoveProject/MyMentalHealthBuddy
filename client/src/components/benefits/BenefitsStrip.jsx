...
const BENEFIT_CATEGORIES = [
  {
    ...
    description: "Feel steadier in under a minute — without forcing anything.",
    userFeels: "I can slow this moment down.",
    icon: Heart,
    color: "var(--glp-sage)",
  },
  {
    ...
    description: "Turn confusion into simple words you can work with.",
    userFeels: "I finally understand what's happening inside me.",
    icon: Eye,
    color: "var(--glp-gold)",
  },
  {
    ...
    description: "Make decisions that respect you — even when it's hard.",
    userFeels: "I can choose my next step.",
    icon: Shield,
    color: "var(--glp-rose)",
  },
  {
    id: "connection",
    title: "Connection (Without Exposure)",
    description: "Feel understood without having to explain yourself.",
    userFeels: "I'm not alone, but I'm still safe.",
    icon: Users,
    color: "var(--glp-sage)",
  },
  {
    ...
    description: "Build momentum without all-or-nothing thinking.",
    userFeels: "I can keep going without pressure.",
    icon: TrendingUp,
    color: "var(--glp-gold)",
  },
  {
    ...
    description: "Align daily choices with who you want to be.",
    userFeels: "I know who I'm becoming.",
    icon: Compass,
    color: "var(--glp-rose)",
  },
];
