...
export default function SacredBackground() {
  return (
    <div className="sacred-bg-container">
      <svg className="sacred-pattern" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
        <circle cx="50" cy="50" r="45" className="circle animate-pulse" />
        <circle cx="50" cy="50" r="30" className="circle animate-pulse-delayed" />
        <circle cx="50" cy="50" r="15" className="circle animate-pulse-more" />
      </svg>
    </div>
  );
}
