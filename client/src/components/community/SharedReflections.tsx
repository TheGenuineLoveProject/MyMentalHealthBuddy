...
export function SharedReflections() {
  return (
    <section style={{ padding: 16, border: "1px solid var(--glp-gray-200)", borderRadius: 12 }}>
      ...
      <div style={{ display: "grid", gap: 12 }}>
        {sharedReflections.map((r) => (
          <div key={r.id} style={{ padding: 12, borderRadius: 10, border: "1px solid var(--glp-gray-100)" }}>
            {safeTextOrFallback(
              r.text,
