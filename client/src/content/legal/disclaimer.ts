export const PLATFORM_DISCLAIMER = {
  ...
  privacyNote:
    "Do not share personal identifiers or sensitive confidential information in public/community areas. Use your best judgment.",
  aiLimitations:
    "AI-generated content may be imperfect. Use what helps, skip what doesn’t, and consult professionals for health decisions.",
} as const;