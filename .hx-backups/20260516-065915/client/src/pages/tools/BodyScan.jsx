          ...
          <CardContent className="p-8">
            {completed ? (
              ...
              <>
                ...
                <div className="mb-6">
                  <div className="h-2 bg-muted rounded-full overflow-hidden" role="progressbar" aria-valuenow={Math.round(totalProgress)} aria-valuemin={0} aria-valuemax={100} aria-label="Body scan progress">
                    <div 
                ...
                <div className="flex justify-center gap-4" role="group" aria-label="Playback controls">
                  <Button
                    ...
                    aria-label={isPlaying ? "Pause body scan" : (progress > 0 ? "Resume body scan" : "Begin body scan")}
                  >
                    {isPlaying ? (
                      <>
                  ...
                  <Button variant="outline" size="lg" onClick={reset} data-testid="button-reset" aria-label="Reset body scan" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2">
