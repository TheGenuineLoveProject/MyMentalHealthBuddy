...
const allContent = [
  ...
  { name: "Advanced Tools", path: "/advanced", description: "Additional reflection and exploration tools", category: "Tools", icon: Zap, protected: true },
  ...
  { name: "Analytics", path: "/analytics", description: "Track your mood and reflection patterns", category: "Dashboard", icon: BarChart3, protected: true },
  ...
  { name: "Community", path: "/community", description: "Connect with others", category: "Community", icon: Users, protected: true },
