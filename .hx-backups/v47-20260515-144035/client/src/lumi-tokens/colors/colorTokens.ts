 ...
 *
 * HX-OS vNEXT Canonical Color Palette — LOCKED.
 * @version 1.0.0
 * @since Phase 41
 */
...
export const GRADIENTS = {
  primaryButton: `linear-gradient(135deg, ${COLORS.serenitySage} 0%, ${COLORS.deepTeal} 100%)`,
  heroBackground: `linear-gradient(180deg, ${COLORS.warmCream} 0%, ${COLORS.mist} 100%)`,
  calmDepth: `linear-gradient(180deg, ${COLORS.deepTeal} 0%, ${COLORS.deepForest} 100%)`,
  softGlow: `radial-gradient(circle, rgba(212, 175, 55, 0.15) 0%, transparent 70%)`,
} as const;

export const OPACITY = {
  full: 1, high: 0.78, medium: 0.5, low: 0.25, subtle: 0.08, ghost: 0.04,
} as const;

export const FORBIDDEN_COLORS = [
  "#000000", "#FF0000", "#FF6B6B", "#00FF00", "#0000FF",
  "#FF00FF", "#00FFFF", "#FFA500", "#FFFFFF",
] as const;

export function isForbiddenColor(hex: string): boolean {
  return FORBIDDEN_COLORS.includes(hex.toUpperCase() as (typeof FORBIDDEN_COLORS)[number]);
}
